...
Public Class MeaningfulInputCheckTest
    <Test>
    Public Sub IsMeaningfulInputが指定桁の整数の時はTrueを返す()
    ...
    <TestCase("abc", "1234", 4)>
    <TestCase("123", "1234", 4)>
    Public Sub IsMeaningfulInputがgiveupでなく指定桁の整数でもない場合はFalseを返す(answerNumber As String, questionNumber As String, digitNumber As Integer)
        Dim mic As New MeaningfulInputCheck
