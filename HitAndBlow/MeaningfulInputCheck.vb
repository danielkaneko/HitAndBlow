Public Class MeaningfulInputCheck
    ...
    Public Function IsMeaningfulInput(answerNumber As String, questionNumber As String) As Boolean
        Dim ianc As New InputAnswerNumberChecker
        IsGiveUp = ianc.IsInputGiveUp(answerNumber)
        Dim isAnswerNumber As Boolean = ianc.IsInputAnswerNumber(answerNumber, questionNumber)
    ...
    Public Function WaitForMeaningfulInput(questionNumber As String) As String
        Dim answerNumber As String
        Do
            Console.WriteLine("** 数値を入力してください **")
            answerNumber = Console.ReadLine()
        Loop While Not IsMeaningfulInput(answerNumber, questionNumber)
        Return answerNumber
    End Function
End Class
